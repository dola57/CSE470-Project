  ...
  <body>
      ...
      <div class="line">
        <div class="slider">
          <div id="owl-demo" class="owl-carousel owl-theme">
            <div class="item it2"><img src="../View/image/shopping-shannon-springs-2.jpg" alt="">
            ...
            <div class="item it4"><img src="../View/image/online-shopping-guide.jpg" alt="">
            ...
            <div class="item it3"><img src="../View/image/file-20200810-22-przb4a.jpg" alt="">
               <h2 data-aos="fade-up">Order easily from home<br> gift easily from home<br> by shopping online</h2>
    ...
    <div id="glr" class="gallery">
      ...
      <div class="female g" data-aos="flip-left" data-aos-duration="3000">
          <a href="../Model/showwomen.php"><img src="../View/image/62386966_2402234889822621_1584683988369276928_o-1024x683.jpg" alt=""></a>
      </div>
      <h2 class="f">Women</h2>
      <div class="male g" data-aos="flip-left" data-aos-duration="3000">
        <a href="../Model/showmen.php"><img src="../View/image/row-men-s-suits-hanged-rack-isolated-white-background-wear-collection-182299770.jpg" alt=""></a>
      </div>
      <h2 class="m">Gent's</h2>
      <div class="kid g" data-aos="flip-left" data-aos-duration="3000">
          <a href="../Model/showkids.php"><img src="../View/image/group-portrait-two-cute-adorable-260nw-1044690346.webp" alt=""></a>
      </div>
      <h2 class="k">Kids</h2>
      <div class="tv g" data-aos="flip-left" data-aos-duration="3000">
          <a href="../Model/showaccessories.php"><img src="../View/image/1140-laptops-store.jpg" alt=""></a>
      </div>
      <h2 class="t">Accessories</h2>
      <div class="grocery g" data-aos="flip-left" data-aos-duration="3000">
          <a href="../Model/showgrocery.php"><img src="../View/image/downloadd.jpg" alt=""></a>
      </div>
